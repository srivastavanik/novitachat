...
// Update usage (called by chat endpoints) with validation and rate limiting
...
// Check if user has remaining quota with validation
...
// Reset usage (called by a daily cron job or middleware) with parameterized query
